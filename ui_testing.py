...
class DownloadUI(QWidget):
    def __init__(self):
        ...
        # External Classes
        #####################################################################
        # Initialize main UI to get data from
        self.mainUI = UI()
        ...
        self.set_ticker(self.mainUI.edit_dl_ticker.text())
        ...
        #######################
        # ==> Downloading inputs
        # type, self.mainUI.combo_dl_downloadt
        # DB_PATH
        # Ticker
        # CSV PATH
        # Download Type 
        ...
        # ==> Create Loading Worker and Thread
        self.obj_download = DownloadWorker(
            self.mainUI.combo_dl_downloadt.currentText(), 
            self.mainUI.edit_dl_dbpath.text(), 
            self.mainUI.edit_dl_ticker.text(), 
            self.mainUI.edit_dl_csvpath.text(), 
            self.mainUI.combo_dl_downloadopt.currentText(), 
            1
        )

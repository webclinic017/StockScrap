...
- [Stock Data Scrapper using MarketWatch and Yahoo Finance!](#stock-data-scrapper-using-marketwatch-and-yahoo-finance-)
  * [Table of Contents](#table-of-contents)
    ...
    + [Documentation](#documentation)
      - [Downloader class](#downloader-class-1)
      ...
      - [BondRate class](#bondrate-class)
        * [method BondRate.bondrate](#method-bondratebondrate)
      - [Intrinsic(BondRate) class](#intrinsic-bondrate--class)
        * [method Intrinsic.intrinsic](#method-intrinsicintrinsic)
